...
AppDataSource.initialize().then(() => __awaiter(void 0, void 0, void 0, function* () {
     ...
     */
    app.post('/api/tasks/migrate-folder-tmdbid', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const dryRun = req.body.dryRun !== false; // 默认 true（安全）
            // 查询候选任务：有 TMDB ID 且 realFolderName 存在且未含标记
            const candidates = yield taskRepo
            ...
            for (const item of toMigrate) {
                try {
                    ...
                    const renameResult = yield cloud189.renameFolder(renameRequest);
                    if (!renameResult || (renameResult.res_code && renameResult.res_code !== 'Success')) {
                        const errMsg = (renameResult === null || renameResult === void 0 ? void 0 : renameResult.res_message) || '云盘重命名失败';
