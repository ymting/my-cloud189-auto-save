...
class WeChatWorkService {
    ...
    getAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this._get(url);
            if (data.errcode !== 0) {
    ...
    sendNewsMessage(userId, articles) {
        return __awaiter(this, void 0, void 0, function* () {
            const token = yield this.getAccessToken();
            const url = `https://qyapi.weixin.qq.com/cgi-bin/message/send?access_token=${token}`;
            const body = {
    ...
    setupDefaultMenu() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.createMenu(menu);
                if (result.errcode === 0) {
...
class WeChatWorkManager {
    ...
    setSession(userId, data) {
        this.sessions.set(userId, Object.assign(Object.assign({}, this.getSession(userId)), data));
    }
    clearSession(userId) {
        this.sessions.set(userId, { state: 'idle' });
    }
    ...
    sendText(userId, text) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.service)
                return;
            try {
                yield this.service.sendTextMessage(userId, text);
            }
            catch (e) {
    ...
    sendTmdbFailAlert(task) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.sendText(null, content);
        });
    }
}
WeChatWorkManager.instance = null;
